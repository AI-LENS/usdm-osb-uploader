...
@cli.command
async def create_study_properties(usdm_file: FilePath, study_id: str):
    """Create a study properties in the OSB system."""
    usdm_data = load_study_design(usdm_file)
    study_designs = (
        usdm_data.get("study", {}).get("versions", [])[0].get("studyDesigns", [])
    )
    return await create_study_high_level_design(study_designs, study_id)


@cli.command
async def create_study_arms(usdm_file: FilePath, study_id: str):
...
@cli.command
async def create_study_populations(usdm_file: FilePath, study_id: str):
...
@cli.command
async def create_study_objectives_endpoints(usdm_file: FilePath, study_id: str):
...
@cli.command
async def create_study_elements(usdm_file: FilePath, study_id: str):
...
@cli.command
async def create_study_criteria_cmd(usdm_file: FilePath, study_id: str):
...
@cli.command
async def create_study_activities(usdm_file: FilePath, study_id: str):
...
@cli.command
async def create_study_epochs_cmd(usdm_file: FilePath, study_id: str):
...
@cli.command
async def create_study_visits_cmd(usdm_file: FilePath, study_id: str):
...
@cli.command
async def create_soa(usdm_file: FilePath, study_id: str):
